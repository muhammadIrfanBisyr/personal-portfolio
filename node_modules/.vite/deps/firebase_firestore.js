...
function Nl(t2) {
  return La2(t2 = Ia2(t2, Fa2)), new al(t2, (e) => Rl(t2, e));
}
function kl(t2, e) {
  La2(t2 = Ia2(t2, Fa2));
  const n = typeof e == "string" ? function(t3) {
    ...
    try {
      ...
      throw new Q2(G.INVALID_ARGUMENT, "Failed to parse JSON:" + ((e2 = t4) === null || e2 === void 0 ? void 0 : e2.message));
    }
  }(e) : e, s = [];
  if (Array.isArray(n.indexes))
    for (const t3 of n.indexes) {
      const e2 = Ol(t3, "collectionGroup"), n2 = [];
      if (Array.isArray(t3.fields))
        for (const e3 of t3.fields) {
          const t4 = vh("setIndexConfiguration", Ol(e3, "fieldPath"));
          e3.arrayConfig === "CONTAINS" ? n2.push(new gt(t4, 2)) : e3.order === "ASCENDING" ? n2.push(new gt(t4, 0)) : e3.order === "DESCENDING" && n2.push(new gt(t4, 1));
        }
...
!function(t2, e = true) {
  ...
  }, "PUBLIC")), registerVersion(D2, "3.4.12", t2), registerVersion(D2, "3.4.12", "esm2017");
}();
export {
  ol as AbstractUserDataWriter,
  eh as Bytes,
  Ma2 as CACHE_SIZE_UNLIMITED,
  va as CollectionReference,
  ba2 as DocumentReference,
  ...
  ma2 as _validateIsNotUsedTogether,
  Tl as addDoc,
  Cl as arrayRemove,
  Dl as arrayUnion,
  ...
  Ra2 as connectFirestoreEmulator,
  Il as deleteDoc,
  Vl as deleteField,
  za2 as disableNetwork,
  Da as doc,
  th as documentId,
  qa2 as enableIndexedDbPersistence,
  Ka2 as enableMultiTabIndexedDbPersistence,
  Wa2 as enableNetwork,
  tl as endAt,
  Zh as endBefore,
  La2 as ensureFirestoreConfigured,
  Rl as executeWrite,
  ll as getDoc,
